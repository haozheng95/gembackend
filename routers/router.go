...
func versionForV1() {
	...
	ns :=
		beego.NewNamespace("/v1",
			...
			beego.NSRouter("/asset/expand", &controllers.AssetExpandController{}, "*:Get"),
			beego.NSRouter("/unspent/?:coin_type", &controllers.UnspentVout{}, "*:Get"),
			beego.NSRouter("/totalsum", &controllers.Totalsum{}, "*:Get"),
			// --post
